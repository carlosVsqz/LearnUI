...
$$
    ...
    BEGIN
        ...
        VALUES (batchId[1], programId[1], '2020', '2020-01-19', '2020-07-19',
                'notes for batch 1');

        INSERT INTO batches (id, program_id, name, start_date, end_date, notes)
        VALUES (batchId[2], programId[1], '2021', '2021-01-15', '2021-07-15',
                'notes for batch 2');

        INSERT INTO batches (id, program_id, name, start_date, end_date, notes)
        VALUES (batchId[3], programId[2], '2020', '2021-02-20', '2021-07-20',
                'notes for batch 3');
